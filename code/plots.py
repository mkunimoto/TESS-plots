...
def plot_page2(star, imageData):
    ...
    draw_pix_catalog(imageData[0]['diffImageSigma'], imageData[1], ax=axDiff1, annotate=True, magColorBar=True, fs=fs-2, ss=50)
    axDiff1.set_title('Diff Image SNR', fontsize=fs-2)
    draw_pix_catalog(imageData[0]['diffImageSigma'], imageData[1], ax=axDiff2, annotate=True, magColorBar=True, close=True, fs=fs-2, ss=200)
    axDiff2.set_title('Diff Image SNR (Close)', fontsize=fs-2)
    draw_pix_catalog(imageData[0]['meanOutTransit'], imageData[1], ax=axDir1, annotate=True, magColorBar=True, fs=fs-2, ss=50)
    axDir1.set_title('Direct Image', fontsize=fs-2)
    draw_pix_catalog(imageData[0]['meanOutTransit'], imageData[1], ax=axDir2, annotate=True, magColorBar=True, close=True, fs=fs-2, ss=200)
