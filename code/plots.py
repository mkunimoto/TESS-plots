...
def plot_page1(star, planet, imageData):
    ...
    # Difference Images
    plot_pix_catalog(axDiff1, imageData[0]['diffImageSigma'], imageData[1], filterStars=True, dMagThreshold=4, fs=fs, ss=10)
    axDiff1.set_title('Diff Image SNR', fontsize=fs)
    plot_pix_catalog(axDiff2, imageData[0]['diffImageSigma'], imageData[1], close=True, filterStars=True, dMagThreshold=4, fs=fs, ss=40)
    axDiff2.set_title('Diff Image SNR (Close)', fontsize=fs)
    plot_pix_catalog(axDir1, imageData[0]['meanOutTransit'], imageData[1], filterStars=True, dMagThreshold=4, fs=fs, ss=10)
    axDir1.set_title('Direct Image', fontsize=fs)
    plot_pix_catalog(axDir2, imageData[0]['meanOutTransit'], imageData[1], close=True, filterStars=True, dMagThreshold=4, fs=fs, ss=40)
...
def plot_page2(star, imageData):
    ...
    plot_pix_catalog(axDiff1, imageData[0]['diffImageSigma'], imageData[1], annotate=True, magColorBar=True, fs=fs-2, ss=50)
    axDiff1.set_title('Diff Image SNR', fontsize=fs-2)
    plot_pix_catalog(axDiff2, imageData[0]['diffImageSigma'], imageData[1], annotate=True, magColorBar=True, close=True, fs=fs-2, ss=200)
    axDiff2.set_title('Diff Image SNR (Close)', fontsize=fs-2)
    plot_pix_catalog(axDir1, imageData[0]['meanOutTransit'], imageData[1], annotate=True, magColorBar=True, fs=fs-2, ss=50)
    axDir1.set_title('Direct Image', fontsize=fs-2)
    plot_pix_catalog(axDir2, imageData[0]['meanOutTransit'], imageData[1], annotate=True, magColorBar=True, close=True, fs=fs-2, ss=200)
